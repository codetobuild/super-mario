...
function initMap() {
    // The location of SuperNintendoWorld
    // 34.667912684397834, 135.4305061701292
    const SuperNintendoWorld = { lat: 34.667912684397834, lng: 135.4305061701292 };
    // The map, centered at Uluru
    const map = new google.maps.Map(document.getElementById("map"), {
      zoom: 15,
      center: SuperNintendoWorld,
      mapId: '7e8fc82e13feca50'
    });
